...
#if !defined (MIRYOKU_LAYOUTMAPPING_PICO)

#define XXX KC.NO

#define MIRYOKU_LAYOUTMAPPING_PICO( \
...
XXX, K20, K21, K22, K23, K24,      K25, K26, K27, K28, K29, XXX, U_LF \
          XXX, K32, K33, K34,      K35, K36, K37, XXX U_LF

#endif

#define MIRYOKU_MAPPING MIRYOKU_LAYOUTMAPPING_PICO
